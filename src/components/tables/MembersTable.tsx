...
import EmployeesTableDropDown from '../dropdowns/MembersTableDropDown'
import MembersDeleteAccountModal from '../modals/members/MembersDeleteAccountModal'
import { MembersTableDataType } from '../../types/tables/members'
import { membersData } from '../../data/table/memebersTableData'



  const columnHelper = createColumnHelper<MembersTableDataType>()
  ...
  const columns = [
    ...
    columnHelper.accessor('committee', {
        header:'Commitee',
  ...
  return (
    ...
    <div className="p-2 registration-table">
        ...
        <div>
            ...
            {modalTypeActive === 'delete-members-account-modal' && <MembersDeleteAccountModal selectedRowData={selectedRowData} handleCloseModal={handleCloseModal} />}
