...
interface OrganizationDeleteAccountModalProps {
  handleCloseModal: () => void;
  selectedRowData:object|null
}

const OrganizationDeleteAccountModal = ({
  handleCloseModal,selectedRowData
}: OrganizationDeleteAccountModalProps) => {
  if (selectedRowData){
...
export default OrganizationDeleteAccountModal;
